...
echo [BUILD] Compiling Guard using Darklua...
darklua process modules/Guard/src/init.lua dist/Guard.luau
if %ERRORLEVEL% NEQ 0 (
...
echo [SUCCESS] Build succeeded! Files saved to dist/mono-ui.luau and dist/Guard.luau
